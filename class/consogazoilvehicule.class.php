...
class ConsogazoilVehicule extends CommonObjectConsoGazoil {
	...
	function create($user, $notrigger = 0) {
		...
		if (isset($this->immat_veh))
			$this->immat_veh = trim($this->immat_veh);
		if (isset($this->brand_veh))
			$this->brand_veh = trim($this->brand_veh);
		if (isset($this->variant_veh))
			$this->variant_veh = trim($this->variant_veh);
		if (isset($this->commercial_name_veh))
			$this->commercial_name_veh = trim($this->commercial_name_veh);
		if (isset($this->avg_conso))
			$this->avg_conso = trim($this->avg_conso);
		if (isset($this->fk_user_creat))
			$this->fk_user_creat = trim($this->fk_user_creat);
		if (isset($this->fk_user_modif))
			$this->fk_user_modif = trim($this->fk_user_modif);
		if (isset($this->activ))
			$this->fk_user_modif = trim($this->activ);
	...
	function delete($user, $notrigger = 0) {
		...
		if (! $error) {
			$sql = "DELETE FROM " . MAIN_DB_PREFIX . "consogazoil_vehicule_extrafields";
